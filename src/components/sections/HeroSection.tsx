      ...
      opacity
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          ease: "easeOut"
            ...
            {subtitle && <p className="text-xl md:text-2xl text-muted-foreground max-w-xl leading-relaxed">
                {subtitle}
              </p>}
          ...
          ease: "easeOut"
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-large">
              {videoUrl ? <video autoPlay loop muted playsInline className="w-full h-[500px] object-cover">
                  <source src={videoUrl} type="video/mp4" />
                </video> : backgroundImage ? <img src={backgroundImage} alt="Hero" className="w-full h-[500px] object-cover" /> : <img src={heroEducationBg} alt="Education" className="w-full h-[500px] object-cover" />}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent" />
            </div>

            {/* Floating Info Card */}
            <div className="absolute bottom-8 right-8 bg-primary text-white p-6 rounded-2xl shadow-blue max-w-xs animate-fade-in" style={{
            animationDelay: '0.3s'
          }}>
              <p className="text-sm leading-relaxed mb-4">
                {subtitle || "Delivering excellence in education consulting for over two decades"}
              </p>
              <Button asChild size="sm" variant="secondary" className="bg-white text-primary hover:bg-white/90 rounded-lg">
